          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            <div className="bg-gray-50 p-10 rounded-3xl border border-gray-100 shadow-sm relative">
              ...
              <div className="prose text-gray-700 font-medium leading-relaxed">
                <p>
                  <strong>חשוב לנו להדגיש: אנחנו לא בית דפוס ולא חנות ספרים.</strong> אנחנו פלטפורמה דיגיטלית חדשנית שהמטרה שלה היא לתת מקום לסופרים לפרסם את עצמם בצורה נוחה ומסודרת.
                </p>
                <p>
                  איך זה עובד? סופרים נרשמים, פותחים חנות משלהם בקליק, ומעלים את הספרים שלהם לפלטפורמה בחינם. הקוראים רוכשים את הספרים ישירות דרך האתר. אנחנו מטפלים בסליקה המאובטחת ובמערכת המשלוחים שתאסוף את הספר מבית הסופר ותמסור אותו ישירות אליכם.
                </p>
