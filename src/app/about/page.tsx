...
export const metadata: Metadata = {
  title: 'אודות סיפור קרוב | Book To Table',
  description: 'הסיפור של סיפור קרוב (Book To Table) — הפלטפורמה הישראלית שמחברת סופרים עצמאיים ישירות לקוראים. ללא עמלות, ללא מתווכים. 100% מהמכירה הולך לסופר.',
  alternates: {
    canonical: 'https://www.booktotable.com/about',
  },
  openGraph: {
    title: 'אודות סיפור קרוב | Book To Table',
    description: 'סיפור קרוב (Book To Table) — הפלטפורמה הישראלית שמחברת סופרים עצמאיים ישירות לקוראים.',
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-3xl font-black text-gray-900 mb-6">החזון שלנו</h2>
              <div className="prose prose-lg text-gray-600 font-medium leading-relaxed">
                <p>
                  אנחנו מאמינים בחיבור ישיר ובלתי אמצעי בין יוצרים לקוראים. יצירת ספר היא מסע מופלא הדורש השקעה רבה של זמן, כישרון ומשאבים בהפקה, עריכה, הגהה ועיצוב.
                </p>
                <p>
                  המטרה שלנו היא לאפשר לסופרים עצמאיים להגיע ישירות אל קהל הקוראים שלהם, ולבנות קהילה תומכת שמעריכה את היצירה המקורית שלהם ומאפשרת להם להתפרנס ממנה בכבוד רב.
                </p>
              </div>
            </div>
            <div className="bg-gray-50 p-10 rounded-3xl border border-gray-100 shadow-sm relative">
              ...
              <h2 className="text-2xl font-black text-green-800 mb-6">הפלטפורמה שלנו: BookToTable</h2>
              <div className="prose text-gray-700 font-medium leading-relaxed">
                <p>
                  <strong>אנחנו פלטפורמה דיגיטלית חדשנית</strong> שנועדה לתת במה מרכזית לסופרים לפרסם את עצמם בצורה נוחה, יפה ומסודרת.
                </p>
                <p>
                  איך זה עובד? סופרים נרשמים, פותחים חנות משלהם בקליק, ומעלים את הספרים שלהם לפלטפורמה בחינם. הקוראים רוכשים את הספרים ישירות דרך האתר. אנחנו מספקים לסופרים את הכלים לנהל את המכירות והמשלוחים בצורה עצמאית ומלאה, עם סליקה נוחה ומאובטחת.
                </p>
                <p className="font-bold text-xl text-green-700 mt-4">
                  התוצאה? הסופר שומר אצלו 100% מסכום המכירה!
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 text-center">
              ...
              <p className="text-gray-600 font-medium leading-relaxed">
                כל שקל שאתם מוציאים כאן הולך ישירות לסופר האהוב עליכם, ומאפשר לו להמשיך ליצור.
              </p>
            </div>
