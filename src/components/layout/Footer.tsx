...
// Facebook SVG icon (official brand color)
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex items-center gap-3 mt-6">
              ...
              <button
                ...
                className="w-8 h-8 rounded-lg bg-gray-100 flex items-center justify-center text-gray-500 hover:bg-green-500 hover:text-white transition-all"
                title="צור קשר במייל"
              >
              ...
              {/* Facebook page */}
              <a
                href="https://www.facebook.com/profile.php?id=61594173094547"
                target="_blank"
                rel="noopener noreferrer"
                className="w-8 h-8 rounded-lg bg-gray-100 flex items-center justify-center text-gray-500 hover:bg-[#1877F2] hover:text-white transition-all"
                title="סיפור קרוב בפייסבוק"
              >
                ...
                <form onSubmit={handleContactSubmit} className="space-y-4">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    <a
                      ...
                      className="flex items-center gap-1.5 text-xs bg-gray-100 hover:bg-green-50 hover:text-green-700 text-gray-600 px-3 py-1.5 rounded-full font-medium transition-colors"
                    >
                      <Mail size={13} /> noamhemo2001@gmail.com
                    </a>
                    <a
                      href="https://www.facebook.com/profile.php?id=61594173094547"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-1.5 text-xs bg-gray-100 hover:bg-blue-50 hover:text-[#1877F2] text-gray-600 px-3 py-1.5 rounded-full font-medium transition-colors"
                    >
                      <FacebookIcon size={13} /> סיפור קרוב בפייסבוק
                    </a>
                  </div>
